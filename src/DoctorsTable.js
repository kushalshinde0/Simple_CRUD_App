    ...
    return (
        <div className='tabledoctor'>
                ...
                <tbody>
                    {Doctors.map((doctor) => (
                        <tr key={doctor.id}>
                            ...
                            <td>
                            <button className="edit" onClick={() => handleEdit(doctor)}>Edit </button> &nbsp;
                            <button className="delete" onClick={() => handleDelete(doctor.id)}>Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
            ...
            <form onSubmit={handleSubmit}>
                ...
                specification :  <input name='specification' value={form.specification} onChange={handleChange} placeholder='Enter specification' />
                Phone Number <input name='phone_num' value={form.phone_num} onChange={handleChange} placeholder='Enter your phone number' />
                Location :  <input name='location' value={form.location} onChange={handleChange} placeholder='Enter location'/> &nbsp;
